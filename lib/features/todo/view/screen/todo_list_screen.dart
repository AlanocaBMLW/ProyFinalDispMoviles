...
class _ToDoListScreenState extends State<ToDoListScreen> {
  ...
  Widget header() {
    return Padding(
      ...
      child: Row(
        children: [
          const Text("Tarea", style: headLine2),
...
//Creacion de la tarea del screen
  Widget createTodo() {
    return Card(
      child: ListTile(
...
// para poder crear una nueva tarea
              ...
              children: [
                TextInput(
                  ...
                  validator: (String? input) {
                    ...
                    return "TItulo necesita al menos 4 caracteres";
                  },
                ),
                ...
                switch (_controller.apiStatus.value) {
                  case ApiState.loading:
                    return const ProgressDialog(
                      title: "borrando tarea...",
                      isProgressed: true,
                    );
                  case ApiState.success:
                    return ProgressDialog(
                      title: "Exitosamente borrado",
                      onPressed: () {
                        _controller.getTodos(widget.user.id!);
                        Navigator.pop(context);
                      },
...
//constructor del cuerpo de las tareas
  @override
