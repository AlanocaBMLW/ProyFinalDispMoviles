...
class _PostListScreenState extends State<PostListScreen> {
  ...
  Widget floatingActionButton(BuildContext context) {
    return FloatingActionButton.extended(
      ...
      label: const Text("Crear nuevo post"),
      onPressed: () async {
            ...
            child: Column(
              ...
              children: [
                ...
                Obx(
                  () {
                    return Text(
                      "publicaciones :${postController.postLength}",
...
//Agarrar los post de cada usert
...
//construye la parte que muestra todos los posts
  @override
      ...
      body: Column(
        ...
        children: [
          ...
          const Padding(
            ...
            child: Text("publicaciones", style: headLine1),
          ),
          postController.obx(
            ...
            onEmpty: const EmptyWidget(message: "No hay publicaciones"),
          ),
        ],
      ),
    );
